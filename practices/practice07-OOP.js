...
/*
const maxAge = (ages.reduce((max, curr) => Math.max(max, curr), -Infinity));
for(const student of students){
    if(student.age === maxAge) console.log(`${student.fName} ${student.lName} is the oldest with the age of ${maxAge}`);
}
*/
...
/*
const minAge = (ages.reduce((min, curr) => Math.min(min, curr), Infinity));
for(const student of students){
    if(student.age === minAge) console.log(`${student.fName} ${student.lName} is the youngest with the age of ${minAge}`);
}
*/
